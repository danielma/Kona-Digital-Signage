...
- (void)relaunch:(id)sender
{
	...
	[NSTask launchedTaskWithLaunchPath:daemonPath arguments:[NSArray arrayWithObjects:[[NSBundle mainBundle] bundlePath], [NSString stringWithFormat:@"%d -autoFullScreen YES", [[NSProcessInfo processInfo] processIdentifier]], nil]];
